...
export default function Home() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <Head>
        <title>Imran Khan Portfolio</title>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-black">
        <section className="min-h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl font-burtons">greatkhanjoy</h1>
          ...
          <div className="text-center p-10">
            ...
            <p className="text-md py-5 leading-8 text-gray-800 md:text-lg md:max-w-xl mx-auto dark:text-white">
              Freelance providing services for progarmming and design content
        ...
        <section className="">
          <div className="">
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              ...
              <span className="text-teal-500 dark:text-blue-500">agencies</span>
              , consulted for{' '}
              <span className="text-teal-500 dark:text-blue-500">startups</span>
            ...
            <p className="text-md py-2 leading-8 text-gray-800 dark:text-white">
              I offer from a wide range of services, including progarming and
              design.
            </p>
          </div>
          <div className="lg:flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <p className="py-2">
                Creating elegant design suted for your need design theory.
              </p>
